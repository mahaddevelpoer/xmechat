          ...
          children: [
            ListTile(
              ...
              onTap: () async {
                ...
                await Supabase.instance.client.from(SupabaseConstants.usersTable)
                    .update({'ringtone_url': ''}).eq('id', ref.read(authServiceProvider).currentUserId);
                if (mounted) Navigator.pop(context);
              },
              trailing: IconButton(
                icon: const Icon(Icons.play_circle_fill, color: AppColors.primaryGreen),
                onPressed: () async {
                  await _previewPlayer.setUrl('https://www.soundjay.com/phone/sounds/telephone-ring-01a.mp3');
                  _previewPlayer.play();
                },
              ),
            ),
              ...
              onTap: () async {
                ...
                if (result != null && result.files.isNotEmpty) {
                  ...
                  if (path != null) {
                    ...
                    await Supabase.instance.client.from(SupabaseConstants.usersTable)
                        .update({'ringtone_url': path}).eq('id', ref.read(authServiceProvider).currentUserId);
                  }
                }
                if (mounted) Navigator.pop(context);
              },
            ...
            TextButton(
              ...
              child: const Text('Stop Preview / Close', style: TextStyle(color: AppColors.error)),
            )
          ],
        ),
      ),
          ...
          children: [
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: Row(children: [
                  UserAvatar(url: user?.avatarUrl, name: user?.name ?? '?', radius: 32),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          user?.bio.isEmpty == true ? 'Hey there! I am using XmeChat.' : user?.bio ?? '',
            ...
            _SettingsSection(items: [
              ...
              ListTile(
                leading: const Icon(Icons.music_video, color: AppColors.textSecondary),
                title: const Text('Call Ringtone'),
                ...
                _SettingsTile(
                  ...
                  trailing: Switch(
                    ...
                    onChanged: (v) async {
                      ...
                      await XmeChatRoot.instance.setWindowsAutoStartEnabled(v);
                    },
                  ),
                ),
              ]),
            ...
            _SettingsSection(items: [
              ...
              ListTile(
                leading: const Icon(Icons.format_size, color: AppColors.primaryGreen),
                title: const Text('Font Size', style: TextStyle(fontWeight: FontWeight.w500)),
                subtitle: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Slider(
                    ...
                    Text('${_fontSize.toInt()}px', style: const TextStyle(color: AppColors.textHint, fontSize: 12)),
                  ],
                ),
              ),
            ]),
...
class _SettingsTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) => ListTile(
    ...
    subtitle: subtitle != null
        ...
        : null,
    trailing: trailing ??
        (onTap != null ? const Icon(Icons.chevron_right, color: AppColors.textHint) : null),
    onTap: onTap,
  );
}
